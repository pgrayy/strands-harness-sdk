...
def run_tools(
    handler: Callable[[ToolUse], Generator[Union[ToolResult, Any], None, None]],
    ...
    def handle(tool: ToolUse) -> Generator[dict[str, Any], None, None]:
        tracer = get_tracer()
    ...
    def work(
        ...
        with worker_lock:
            tool_results.append(event["callback"])
